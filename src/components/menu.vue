  ...
  <BContainer fluid>
    ...
    <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
      <div class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse collapse menu-dropdown" id="sidebarDashboards">
            <ul class="nav nav-sm flex-column">
              ...
              <li class="nav-item">
                <router-link
                  to="/parametrage/structures"
                  class="nav-link custom-abc"
                  data-key="t-structure"
                >
                  {{ $t("t-structure") }}
                </router-link>
              </li>
            ...
            <BRow>
              <BCol col lg="4">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <router-link to="/ui/grid" class="nav-link" data-key="t-grid">{{
                      $t("t-grid")
                    }}</router-link>
                  </li>
                </ul>
              ...
              <BCol col lg="4">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <router-link to="/ui/tabs" class="nav-link" data-key="t-tabs">{{
                      $t("t-tabs")
                    }}</router-link>
                  </li>
                  <li class="nav-item">
              ...
              <BCol col lg="4">
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <router-link to="/ui/links" class="nav-link" data-key="t-links"
                      >{{ $t("t-links") }}
                      <BBadge variant="success" class="badge-pill" data-key="t-new">{{
                        $t("t-new")
                      }}</BBadge>
                    </router-link>
                  </li>
        ...
        <div class="mt-4 text-center" v-if="shwoImage">
