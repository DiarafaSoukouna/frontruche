      ...
      checkall.addEventListener("click", function (event) {
        ...
        checkboxes.forEach(function (chkbox) {
          ...
          if (chkbox.checked == true) {
            ...
            chkbox.checked = false;
            chkbox.parentNode.parentNode.parentNode.parentNode.classList.remove("active");
            checkedCount > 0
              ? (document.getElementById("email-topbar-actions").style.display = "block")
              : (document.getElementById("email-topbar-actions").style.display = "none");
          }
  ...
  mounted() {
    ...
    document.querySelectorAll(".email-chat-list a").forEach(function (item) {
      ...
      item.addEventListener("click", function () {
        ...
        Array.from(conversationImg.querySelectorAll(".left .chat-avatar")).forEach(
          function (item) {
            if (userProfile) {
    ...
    document.querySelector(".email-wrapper").addEventListener("click", function () {
      if (
        document.querySelector(".email-menu-sidebar").classList.contains("menubar-show")
      ) {
        if (!isShowMenu) {
        ...
        <div class="p-4 d-flex flex-column h-100">
          ...
          <simplebar class="mx-n4 px-4 email-menu-sidebar-scroll" data-simplebar>
            <div class="mail-list mt-3">
              <BLink href="#" class="active" @click="changemenu('all')"
                ><i class="ri-mail-fill me-3 align-middle fw-medium"></i>
                <span class="mail-list-link">All</span>
                <BBadge
                  variant="success-subtle"
                  class="bg-success-subtle text-success ms-auto"
                  >5</BBadge
                >
              </BLink>
              <BLink href="#" @click="changemenu('Inbox')"
                ><i class="ri-inbox-archive-fill me-3 align-middle fw-medium"></i> Inbox
                <BBadge
                  variant="success-subtle"
                  class="bg-success-subtle text-success ms-auto"
                  >5</BBadge
              ...
              <BLink href="#" @click="changemenu('Sent')"
                ><i class="ri-send-plane-2-fill me-3 align-middle fw-medium"></i>
                Sent</BLink
              >
              <BLink href="#" @click="changemenu('Draft')"
                ><i class="ri-edit-2-fill me-3 align-middle fw-medium"></i>Draft</BLink
              >
              <BLink href="#" @click="changemenu('Spam')"
                ><i class="ri-error-warning-fill me-3 align-middle fw-medium"></i
                >Spam</BLink
              >
              <BLink href="#" @click="changemenu('Trash')"
                ><i class="ri-delete-bin-5-fill me-3 align-middle fw-medium"></i
                >Trash</BLink
              >
              <BLink href="#" @click="changemenu('Starred')"
                ><i class="ri-star-fill me-3 align-middle fw-medium"></i>Starred</BLink
              >
              <BLink href="#" @click="changemenu('Important')"
            ...
            <div>
              ...
              <div class="mail-list mt-1">
                <BLink href="#" @click="changelable('Support')"
                ...
                <BLink href="#" @click="changelable('Family')"
            ...
            <ul class="message-list" id="mail-list-data" style="display: none">
              ...
              <div v-if="tabtype == 'social'">
                ...
                >
                  <div class="col-mail col-mail-1" @click="openemail">
                    ...
                    <BButton
                      type="button"
                      class="btn avatar-xs p-0 favourite-btn fs-15 sszxfsf"
                      :class="{ active: data.starred == true }"
                      @click="toggleFavourite"
                    >
                      <i class="ri-star-fill"></i>
              ...
              <li class="bg-transparent text-center">
                <BButton
                  ...
                  variant="info-subtle"
                  size="sm"
                  class="btn-rounded px-2"
                  ><i class="mdi mdi-spin mdi-loading me-2"></i>Load More</BButton
                >
              </li>
            </ul>
          </div>
              ...
              <BCol>
                <div class="">
                  <BButton
                    ...
                    variant="soft-danger"
                    size="sm"
                    class="btn-icon fs-16 close-btn-email"
                    id="close-btn-email"
                  >
              ...
              <div class="col-auto">
                ...
                >
                  ...
                  <BButton
                    type="button"
                    variant="ghost-secondary"
                    class="btn-icon btn-sm fs-16 remove-mail"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li>
                            <BLink class="dropdown-item" href="#"
                              ><i class="ri-timer-line text-muted me-1 align-bottom"></i>
                              Schedule Send</BLink
                            >
                          </li>
                        </ul>
        ...
        <BCardBody class="p-0">
          ...
          <div class="border-top border-top-dashed">
            <BRow class="g-2 mx-3 mt-2 mb-3">
              ...
              <div class="col-auto">
                <BButton type="submit" variant="info"
      ...
      <div class="modal-footer v-modal-footer">
        ...
        <BButtonGroup class="dropend">
          <BDropdown split text="Send" variant="success">
            <BDropdownItem class="dropdown-item" href="#"
              ><i class="ri-timer-line text-muted me-1 align-bottom"></i> Schedule
              Send</BDropdownItem
            >
          </BDropdown>
        </BButtonGroup>
