...
export default {
  ...
  methods: {
    async getPartenaire() {
      ...
      try {
        const response = await axios.get(
          "https://ssise-cosit.com/api-ssise/partenaire/getAllPartenaire",
          { headers: headers }
        );
    ...
    async getTypePat() {
      ...
      try {
        const response = await axios.get(
          "https://ssise-cosit.com/api-ssise/typePartenaire/getAllTypePartenaire",
          { headers: headers }
        );
    ...
    async updatePartenaire() {
      try {
        await axios
          .post(
            "https://ssise-cosit.com/api-ssise/partenaire/update",
            {
              code_partenaire: this.code_partenaire,
              sigle_partenaire: this.sigle_partenaire,
              definition_partenaire: this.definition_partenaire,
    ...
    async insertTypPat() {
      try {
        await axios
          .post(
            "https://ssise-cosit.com/api-ssise/typePartenaire/insert",
            {
    ...
    async updateTypPat() {
      try {
        await axios
          .post(
            "https://ssise-cosit.com/api-ssise/typePartenaire/update",
            {
    ...
    async deletePartenaire() {
      try {
        await axios
          .delete(
            "https://ssise-cosit.com/api-ssise/partenaire/delete",
            {
    ...
    async deleteTypPat() {
      try {
        await axios
          .delete(
            "https://ssise-cosit.com/api-ssise/typePartenaire/delete",
            {
