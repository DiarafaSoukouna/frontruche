            ...
            <BContainer>
                ...
                <BCollapse class="navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        <li class="nav-item">
                            <a class="nav-link fs-15" href="#hero" @click.prevent="scrollToSection('hero')">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15" href="#wallet" @click.prevent="scrollToSection('wallet')">Wallet
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15" href="#marketplace" @click.prevent="scrollToSection('marketplace')">Marketplace</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15" href="#categories" @click.prevent="scrollToSection('categories')">
                                Categories</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fs-15" href="#creators" @click.prevent="scrollToSection('creators')">
                                Creators</a>
                        </li>
                    </ul>
